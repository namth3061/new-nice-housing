-- Seed blog posts for NineHousing
...
(
  ...
  'NineHousing',
  'Gợi ý',
  E'Phú Quốc có nhiều bãi biển và khu vực nghỉ dưỡng. **Bãi Dài** – yên tĩnh, resort cao cấp. **Dương Đông** – gần chợ đêm, tiện ăn uống. **Bãi Sao** – nước trong, phù hợp gia đình. Đặt phòng sớm trên NineHousing để có giá tốt.'
),
(
  ...
  'NineHousing',
  'Khám phá',
  E'Sapa mùa lạnh đẹp nhất từ tháng 12 đến tháng 2. Mang theo áo ấm, giày chống trơn. Nên đặt homestay gần Fansipan hoặc bản Tả Van. NineHousing gợi ý nhiều homestay view núi giá tốt.'
),
(
  'uu-dai-thang-2-khach-san-resort',
  'Ưu đãi tháng 2: Khách sạn & resort',
  'Tổng hợp mã giảm giá và gói nghỉ dưỡng tháng 2 từ các đối tác NineHousing.',
  '2026-02-03',
  'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&q=80',
  'NineHousing',
  'Mẹo hay',
  E'Tháng 2 nhiều khách sạn ra mắt ưu đãi đầu năm. Giảm đến 20% khi đặt trước 7 ngày. Áp dụng tại Nha Trang, Đà Nẵng, Phú Quốc. Theo dõi trang Khuyến mãi trên NineHousing.'
),
(
  ...
  'NineHousing',
  'Gợi ý',
  E'Vũng Tàu không chỉ có khách sạn lớn. Nhiều homestay view biển với giá 500–800k/đêm, gần Bãi Sau và Bãi Trước. Đặt qua NineHousing được xác nhận nhanh và hỗ trợ đổi lịch.'
),
(
  ...
  'NineHousing',
  'Mẹo hay',
  E'Công tác dài ngày tại Hà Nội nên chọn căn hộ có bếp, máy giặt, gần metro hoặc văn phòng. NineHousing có filter "Căn hộ dịch vụ" và "Cho thuê dài hạn" giúp bạn tìm nhanh.'
),
(
...
(
  ...
  'NineHousing',
  'Gợi ý',
  E'Ngày 1: Vinpearl hoặc bãi biển. Ngày 2: Tour đảo hoặc lặn biển. Ngày 3: Chợ Đầm, mua đặc sản. Ở khách sạn 3–4 sao gần biển giá 800k–1,2tr/đêm trên NineHousing.'
),
(
  ...
  'NineHousing',
  'Xu hướng',
  E'Năm 2026 khách hàng đặt phòng quan tâm nhiều hơn đến chính sách hủy và thanh toán trả sau. Các nền tảng như NineHousing đã bổ sung tùy chọn "Thanh toán tại chỗ" và "Hủy miễn phí trước 24h".'
),
(
  ...
  'NineHousing',
  'Khám phá',
  E'Phú Quốc không chỉ có biển và tour. Nhiều resort tập trung vào wellness: lớp yoga sáng, bữa ăn organic, spa. Tìm filter "Wellness" trên NineHousing để xem danh sách.'
),
(
  ...
  'NineHousing',
  'Mẹo hay',
  E'Mỗi khách sạn có chính sách hủy khác nhau. Thường hủy miễn phí trước 24–48h. Hủy gần ngày có thể mất phí hoặc không hoàn tiền. Đọc kỹ điều khoản khi đặt trên NineHousing.'
),
(
