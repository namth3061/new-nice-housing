...
export default function NewBlogPage() {
  ...
  const onFiles = useCallback((files: FileList | null) => {
    ...
    if (!file.type.startsWith("image/")) {
      setUploadError("Vui lòng chọn file ảnh (JPEG, PNG, GIF, WebP).");
      return;
    }
  ...
  const handleCreate = async () => {
    ...
    const finalSlug = slug.trim() || slugFromTitle(title);
    setSaving(true);
    try {
      const res = await fetch("/api/blogs", {
        ...
        body: JSON.stringify({
          slug: finalSlug, title: title.trim(), excerpt: excerpt.trim(),
          content: content.trim(), category: category.trim(),
          author: author.trim(), date: date || undefined, image: image.trim() || undefined,
          status,
        }),
      });
      const data = await res.json().catch(() => ({}));
      if (res.ok) { router.push("/admin/blogs"); return; }
      setError(data?.error || "Không thể tạo bài viết. Vui lòng thử lại.");
  ...
  return (
    <div className="admin-form-root">
        ...
        <div className="admin-form-header">
          ...
          <div>
            <h1 className="admin-form-title">Thêm bài viết mới</h1>
            <p className="admin-form-subtitle">Điền thông tin và lưu để đăng bài</p>
          </div>
        </div>
          ...
          <div className="admin-form-grid">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                ...
                <div className="admin-form-card-body">
                  ...
                  {imagePreview ? (
                    ...
                    >
                      ...
                      <div>
                        <div className="admin-form-upload-title">
              ...
              <div className="admin-form-actions">
                ...
                <button onClick={() => void handleCreate()} disabled={saving} className="admin-form-submit">
                  {saving ? (
                    <>
                    ...
                    <><Sparkles size={15} /> Đăng bài viết</>
                  )}
                </button>
              </div>
            </div>
              ...
              <div className="admin-form-preview-card">
                ...
                <div className="admin-form-preview-body">
                  <div className="admin-form-preview-img-slot">
                    {imagePreview ? (
                      ...
                      <div className="admin-form-preview-img-empty">
                        ...
                        <span className="admin-form-admin-form-preview-img-empty-label">Chưa có ảnh</span>
                      </div>
                    )}
                  </div>
                  {category && (
                  ...
                  <div className="admin-form-preview-meta">
                    ...
                    {author && date && <span className="admin-form-admin-form-preview-meta-dot" />}
                  ...
                  <p className={`admin-form-preview-excerpt${!excerpt ? " admin-form-preview-placeholder" : ""}`}>
                    {excerpt || "Mô tả ngắn sẽ xuất hiện tại đây sau khi bạn nhập vào trường bên trái."}
                  </p>
                </div>
              </div>
            </div>
