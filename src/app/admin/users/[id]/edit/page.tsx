    ...
    return (
      <div className="admin-form-root">
        <div className="admin-form-header">
          ...
          <Link href="/admin/users" className="text-sm font-semibold mt-2 inline-block" style={{ color: "var(--a-gold)" }}>
            ← Quay lại danh sách
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="admin-form-root">
      <div className="admin-form-header">
        ...
        <div>
          <h1 className="admin-form-title">Chỉnh sửa người dùng</h1>
          <p className="admin-form-subtitle">Cập nhật thông tin qua 2 bước</p>
        </div>
      </div>
      ...
      <div className="admin-form-card">
        ...
        <div className="admin-form-actions" style={{ marginTop: 0, padding: "16px 24px", borderTop: "1px solid #f1f5f9" }}>
          ...
          {step < 2 ? (
            ...
            <button type="button" onClick={() => void handleSubmit()} disabled={saving} className="admin-form-submit">
